...
The base value of possible EXP gain from monsters can be retrieved using the `get_monsters_definitions` tool. The base is the number of EXP that you get if you have the same level as the opponent without any EXP boost.
